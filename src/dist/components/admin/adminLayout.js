...
export default (props) => (
  <section className="adminLayout-section">
    ...
    <div className="adminLayout-section-body" >
      <div>
        <h3>Proponer reto</h3>
        <Link className="linking" to="/admin/propouse">Iniciar</Link>

        <p>Retos en marcha {props.challenges}</p>
      </div>
      <div>
        <h3>Calificar retos</h3>
        <Link className="linking" to="/admin/rating">Calificar</Link>

        <p>Retos enviados {props.sended}</p>
      </div>
      <div>
        <h3>Administrar usuarios</h3>
        <Link className="linking" to="/admin/admin">Administrar</Link>
